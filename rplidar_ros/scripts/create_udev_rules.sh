...
echo "/home/gxf/catkin_ws_complex/src/rplidar_ros/scripts/rplidar.rules"
sudo cp /home/gxf/catkin_ws_complex/src/rplidar_ros/scripts/rplidar.rules  /etc/udev/rules.d
echo " "
